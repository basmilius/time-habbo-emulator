...
public class Pets extends CataloguePage
{

	public Pets(final ResultSet result) throws SQLException
	{
		super(result);
	}
	...
	public void serialize(final ServerMessage response)
	{
		...
		response.appendString("Kies een naam");
		response.appendString("Kies een kleur");
		response.appendString("Kies een ras");
