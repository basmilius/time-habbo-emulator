...
public class MagicStackUserItem extends UserItem
{

	public MagicStackUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public MagicStackUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
