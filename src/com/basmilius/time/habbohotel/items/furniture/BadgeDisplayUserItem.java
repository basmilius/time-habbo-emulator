...
public class BadgeDisplayUserItem extends UserItem
{

	public BadgeDisplayUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public BadgeDisplayUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
