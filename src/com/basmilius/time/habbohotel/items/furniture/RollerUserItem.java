...
public class RollerUserItem extends UserItem
{

	public RollerUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public RollerUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
