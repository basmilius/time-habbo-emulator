...
public class SoundFxUserItem extends UserItem
{

	private boolean secondState = false;

	public SoundFxUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public SoundFxUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
