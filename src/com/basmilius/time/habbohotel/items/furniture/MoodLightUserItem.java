...
public class MoodLightUserItem extends UserItem
{

	public MoodLightUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public MoodLightUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
