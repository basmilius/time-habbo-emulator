...
public class BattleBanzaiUserItem extends UserItem
{

	public BattleBanzaiUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public BattleBanzaiUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
