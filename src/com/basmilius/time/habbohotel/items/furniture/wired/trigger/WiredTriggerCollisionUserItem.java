...
public class WiredTriggerCollisionUserItem extends WiredTriggerUserItem
{

	public WiredTriggerCollisionUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public WiredTriggerCollisionUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
