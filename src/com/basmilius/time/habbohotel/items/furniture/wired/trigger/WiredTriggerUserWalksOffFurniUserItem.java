...
public class WiredTriggerUserWalksOffFurniUserItem extends WiredTriggerUserItem
{

	public WiredTriggerUserWalksOffFurniUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public WiredTriggerUserWalksOffFurniUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
