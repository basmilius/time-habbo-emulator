...
public class FreezeGateBlueGameUserItem extends GameUserItem
{

	public FreezeGateBlueGameUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public FreezeGateBlueGameUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
