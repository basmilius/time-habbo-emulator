...
public class FreezeGateGreenGameUserItem extends GameUserItem
{

	public FreezeGateGreenGameUserItem(final ResultSet result) throws SQLException
	{
		super(result);
	}

	public FreezeGateGreenGameUserItem(final int habboId, final int roomId, final int itemId, final int catalogueItemId, final int itemBoughtBy, final BoughtType itemBoughtType, final int itemExpire)
	{
