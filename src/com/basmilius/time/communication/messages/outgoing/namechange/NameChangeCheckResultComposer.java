...
public class NameChangeCheckResultComposer extends MessageComposer
{
	...
	public NameChangeCheckResultComposer(int result, String name, List<String> availableNames)
	{
		this.result = result;
		this.name = name;
	...
	{
		response.init(Outgoing.NameChangeCheckResult);
