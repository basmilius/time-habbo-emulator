...
public class TalkWhisperComposer extends MessageComposer
{
	...
	public TalkWhisperComposer(RoomUnit unit, String text, Integer emotionId, Integer bubbleId)
	{
		this.unit = unit;
		this.text = text;
	...
	public TalkWhisperComposer(final RoomChatMessage roomChatMessage)
	{
	...
	{
		response.init(Outgoing.Whisper);
