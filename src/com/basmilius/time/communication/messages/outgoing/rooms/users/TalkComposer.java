...
public class TalkComposer extends MessageComposer
{
	...
	public TalkComposer(RoomUnit unit, String text, Integer emotionId, Integer bubbleId)
	{
		this.unit = unit;
		this.text = text;
	...
	public TalkComposer(final RoomChatMessage roomChatMessage)
	{
