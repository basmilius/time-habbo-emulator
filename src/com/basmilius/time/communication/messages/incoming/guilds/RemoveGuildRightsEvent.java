...
@Event(id = Incoming.RemoveGuildRights)
public class RemoveGuildRightsEvent extends MessageEvent
{
	...
	public void handle() throws Exception
	{
		...
		guild.getMemberByHabbo(habbo).setLevel(GuildMemberLevel.MEMBER);
