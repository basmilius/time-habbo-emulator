...
@Event(id = Incoming.StopTyping)
public class StopTypingEvent extends MessageEvent
{
	...
	public void handle() throws Exception
	{
		...
		connection.getHabbo().getCurrentRoom().getRoomUnitsHandler().send(new RoomUserTypingComposer(connection.getHabbo().getRoomUser().getUnitId(), false));
	}
