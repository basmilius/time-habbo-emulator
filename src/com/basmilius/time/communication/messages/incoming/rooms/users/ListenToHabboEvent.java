...
@Event(id = Incoming.ListenToHabbo)
public class ListenToHabboEvent extends MessageEvent
{
	...
	public void handle() throws Exception
	{
		...
		connection.getHabbo().getSettings().getIgnores().removeHabboToIgnore(ignoredUser);
